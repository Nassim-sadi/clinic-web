...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-appointments': RouteRecordInfo<'apps-appointments', '/apps/appointments', Record<never, never>, Record<never, never>>,
    'apps-appointments-id': RouteRecordInfo<'apps-appointments-id', '/apps/appointments/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-appointments-appointment-modal': RouteRecordInfo<'apps-appointments-appointment-modal', '/apps/appointments/AppointmentModal', Record<never, never>, Record<never, never>>,
    'apps-bills': RouteRecordInfo<'apps-bills', '/apps/bills', Record<never, never>, Record<never, never>>,
    'apps-bills-bill-modal': RouteRecordInfo<'apps-bills-bill-modal', '/apps/bills/BillModal', Record<never, never>, Record<never, never>>,
    ...
    'apps-doctors': RouteRecordInfo<'apps-doctors', '/apps/doctors', Record<never, never>, Record<never, never>>,
    'apps-doctors-doctor-modal': RouteRecordInfo<'apps-doctors-doctor-modal', '/apps/doctors/DoctorModal', Record<never, never>, Record<never, never>>,
    ...
    'apps-encounters': RouteRecordInfo<'apps-encounters', '/apps/encounters', Record<never, never>, Record<never, never>>,
    'apps-encounters-encounter-modal': RouteRecordInfo<'apps-encounters-encounter-modal', '/apps/encounters/EncounterModal', Record<never, never>, Record<never, never>>,
    ...
    'apps-patients': RouteRecordInfo<'apps-patients', '/apps/patients', Record<never, never>, Record<never, never>>,
    'apps-patients-patient-modal': RouteRecordInfo<'apps-patients-patient-modal', '/apps/patients/PatientModal', Record<never, never>, Record<never, never>>,
    'apps-permissions': RouteRecordInfo<'apps-permissions', '/apps/permissions', Record<never, never>, Record<never, never>>,
    'apps-prescriptions': RouteRecordInfo<'apps-prescriptions', '/apps/prescriptions', Record<never, never>, Record<never, never>>,
    'apps-prescriptions-prescription-modal': RouteRecordInfo<'apps-prescriptions-prescription-modal', '/apps/prescriptions/PrescriptionModal', Record<never, never>, Record<never, never>>,
    'apps-queue': RouteRecordInfo<'apps-queue', '/apps/queue', Record<never, never>, Record<never, never>>,
    'apps-reports': RouteRecordInfo<'apps-reports', '/apps/reports', Record<never, never>, Record<never, never>>,
    ...
    'apps-services-service-modal': RouteRecordInfo<'apps-services-service-modal', '/apps/services/ServiceModal', Record<never, never>, Record<never, never>>,
    ...
    'apps-users-user-modal': RouteRecordInfo<'apps-users-user-modal', '/apps/users/UserModal', Record<never, never>, Record<never, never>>,
